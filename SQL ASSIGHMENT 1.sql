...
* Also, the foreign key can contain duplicate and null values in a relational database.
----------
*/
...
-- Q8. List the total number of films whose replacemnet cost is greater than $15 and less than  $20.
         ...
         select count(*) from film where replacement_cost > 20 and replacement_cost < 15;
--------------
...
-- Q15.  Display the list of first 4 cities which start and end with ‘a’ . 
              ...
              select * from city where city like '%aa%' limit 4;
---------------
...
-- Q20.  Get the films with pg and pg-13 rating using IN operator. 
        ...
        --  OR     SELECT title FROM film WHERE rating IN ('PG', 'PG-13');
